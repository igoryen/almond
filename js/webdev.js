// create an object
  var object = {
    ...
    , "__dirname - node": "http://nodejs.org/docs/latest/api/globals.html#globals_dirname"
    ...
    , "API - node": "http://nodejs.org/api/all.html"
    , "API - using": "http://gigaom.com/2010/10/29/using-apis-not-quite-as-hard-as-it-looks/"
    , "API - what is it?": "http://www.makeuseof.com/tag/api-good-technology-explained/"
    , "API tutorial - MediaWiki": "http://www.mediawiki.org/wiki/API:Tutorial"
    ...
    , "Beginner Book - node": "http://www.nodebeginner.org/"
    , "Beginner`s Tutorial - node": "http://project70.com/nodejs/beginners-tutorial-node-js/"
    ...
    , "Debugging in the browser": "http://blog.redfin.com/devblog/2013/03/debugging-in-the-browser.html#.Uop2v5TwLoM"
    , "display a clock": "http://www.w3schools.com/js/tryit.asp?filename=tryjs_timing_clock"
    , "Display a clock": "http://www.w3schools.com/js/tryit.asp?filename=tryjs_timing_clock"
    , "Docco - doc generator": "http://jashkenas.github.io/docco/"
    ...
    , "env.getTemplate": "http://nunjucks.jlongster.com/api#Loading-a-template"
    , "Environment variables work": "http://kleeschulte.blogspot.ca/2008/06/how-environment-variables-really-work.html"
    , "escapeString": "http://php.net/manual/en/sqlite3.escapestring.php"
    ...
    , "Event emitters - node": "http://docs.nodejitsu.com/articles/getting-started/control-flow/what-are-event-emitters"
    ...
    , "Filesystem Hyerarchy Standard": "http://www.pathname.com/fhs/pub/fhs-2.3.html"
    ...
    , "fs.existsSync(path) - node": "http://nodejs.org/api/fs.html#fs_fs_existssync_path"
    , "fs.Stats - node": "http://nodejs.org/api/fs.html#fs_class_fs_stats"
    , "fs.statSync(path) - node": "http://nodejs.org/api/fs.html#fs_fs_statsync_path"
    , "fs.writeFile() - node": "http://nodejs.org/api/fs.html#fs_fs_writefile_filename_data_options_callback"
    , "function": "http://www.w3schools.com/js/js_functions.asp"
    , "Get started - node": "http://stackoverflow.com/questions/2353818/how-do-i-get-started-with-node-js"
    ...
    , "GitHow": "http://githowto.com/"
    , "Global State is Evil": "http://programmers.stackexchange.com/questions/148108/why-is-global-state-so-evil"
    ...
    , "Grunt Basics - Landhoft": "http://www.youtube.com/watch?v=q3Sqljpr-Vc"
    , "Grunt task-runner": "http://gruntjs.com/"
    , "grunt.config.init": "http://gruntjs.com/api/grunt.config#grunt.config.init"
    , "grunt.fatal": "http://gruntjs.com/api/grunt.fail#grunt.fatal"
    , "grunt.file.copy": "http://gruntjs.com/api/grunt.file#grunt.file.copy"
    , "grunt.file.delete": "http://gruntjs.com/api/grunt.file#grunt.file.delete"
    , "grunt.file.exists": "http://gruntjs.com/api/grunt.file#grunt.file.exists"
    , "grunt.file.expand": "http://gruntjs.com/api/grunt.file#grunt.file.expand"
    , "grunt.file.isDir": "http://gruntjs.com/api/grunt.file#grunt.file.isdir"
    , "grunt.file.mkdir": "http://gruntjs.com/api/grunt.file#grunt.file.mkdir"
    , "grunt.file.read": "http://gruntjs.com/api/grunt.file#grunt.file.read"
    , "grunt.file.readJson": "http://gruntjs.com/api/grunt.file#grunt.file.readjson"
    , "grunt.file.write": "http://gruntjs.com/api/grunt.file#grunt.file.write"
    , "grunt.initConfig": "http://gruntjs.com/api/grunt#grunt.initconfig"
    , "grunt.loadNpmTasks": "http://gruntjs.com/api/grunt#grunt.loadnpmtasks"
    , "grunt.option - Grunt": "http://gruntjs.com/api/grunt#grunt.option"
    , "grunt.task.loadNpmTasks": "http://gruntjs.com/api/grunt.task#grunt.task.loadnpmtasks"
    , "grunt.task.registerTask": "http://gruntjs.com/api/grunt.task#grunt.task.registertask"
    , "grunt.task.run": "http://gruntjs.com/api/grunt.task#grunt.task.run"
    , "grunt.util.spawn": "http://gruntjs.com/api/grunt.util#grunt.util.spawn"
    , "grunt.verbose.writeln": "http://gruntjs.com/api/grunt.log#grunt.log.write-grunt.verbose.write"
    ...
    , "HTML entities en/de-code": "http://htmlentities.net/"
    , "Ideone.com": "http://ideone.com/"
    , "init - npm": "https://npmjs.org/doc/init.html"
    , "input tag" : "http://www.w3schools.com/tags/tag_input.asp"
    , "Intro by Ryan Dahl": "http://www.youtube.com/watch?v=jo_B4LTHi3I"
    , "JavaScript": "http://www.w3schools.com/js/default.asp"
    , "join() - js": "http://www.w3schools.com/jsref/jsref_join.asp"
    ...
    , "JS module loaders": "http://ruben.verborgh.org/blog/2012/08/13/javascript-module-loaders-necessary-evil/"
    , "JS the Good Parts": "http://eleventyone.done.hu/OReilly.JavaScript.The.Good.Parts.May.2008.pdf"
    , "JSON.parse - js": "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/JSON/parse"
    , "JSON.stringify - js": "http://msdn.microsoft.com/en-us/library/ie/cc836459(v=vs.94).aspx"
    , "Key Codes": "http://www.webonweboff.com/tips/js/event_key_codes.aspx#instant-test"
    ...
    , "Logical Operators - MDN": "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Logical_Operators?redirectlocale=en-US&redirectslug=JavaScript%2FReference%2FOperators%2FLogical_Operators"
    ...
    , "module.exports - node": "http://nodejs.org/api/modules.html#modules_module_exports"
    ...
    , "Node.js better? - B.Ford": "http://www.youtube.com/watch?v=C5fa1LZYodQ"
    , "Node.js on Fedora": "http://fedoraproject.org/wiki/Features/NodeJS"
    , "Node.js - presented by Ryan Dahl": "http://www.infoq.com/presentations/nodejs"
    , "NOT NOT (!!)": "http://stackoverflow.com/questions/4686583/can-someone-explain-this-double-negative-trick"
    ...
    , "path - node": "http://nodejs.org/docs/v0.4.9/api/path.html"
    , "path.basename() - node": "http://nodejs.org/api/path.html#path_path_basename_p_ext"
    , "path.dirname(p) - node": "http://nodejs.org/api/path.html#path_path_dirname_p"
    , "path.join() - node": "http://nodejs.org/api/path.html#path_path_join_path1_path2"
    , "path.relative(from, to) - node": "http://nodejs.org/api/path.html#path_path_relative_from_to"
    ...
    , "process.cwd() - Node": "http://nodejs.org/api/process.html#process_process_cwd"
    , "process.env - node": "http://nodejs.org/api/process.html#process_process_env"
    ...
    , "Reg Ex - php": "http://zenit.senecac.on.ca/~int322_123a07/practice/121028_regex.php"
    , "RegEx Pal": "http://regexpal.com/"
    , "RegExp": "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp"
    , "RegExp.exec": "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/RegExp/exec"
    , "render - nunjucks": "http://nunjucks.jlongster.com/api#Rendering-a-template"
    ...
    , "setTimeOut() 1 - js": "http://www.w3schools.com/js/js_timing.asp"
    , "setTimeOut() 2 - js": "http://www.w3schools.com/jsref/met_win_settimeout.asp"
    , "sitemap": "https://github.com/mozilla/webmaker.org/commit/ec10ab7d534bb8b669573f31e3f2057d753b6d3c"
    ...
    , "String.replace -js": "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/String/replace"
    ...
    , "submodules - git": "http://git-scm.com/book/en/Git-Tools-Submodules"
    ...
    , "toUTCString() 1": "http://www.w3schools.com/jsref/jsref_toutcstring.asp"
    , "toUTCString() 2": "http://www.w3schools.com/jsref/tryit.asp?filename=tryjsref_toutcstring"
    , "trim() - jQ": "http://jsfiddle.net/KCza9/"
    , "try-catch-finally - node": "http://docs.nodejitsu.com/articles/errors/what-is-try-catch"
    , "tympanus": "http://tympanus.net/codrops/"
    , "typeof - js": "https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/typeof"
    , "UglifyJS 1": "http://marijnhaverbeke.nl/uglifyjs"
    , "uglifyjs 2 - why?": "http://lisperator.net/uglifyjs/"
